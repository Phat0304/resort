...
@section('content')
    <div class="d-flex align-items-center  justify-content-between  ">
        <h3><i class="bi bi-list-task"></i> รายการเช็คอิน</h3>

        {{-- วันที่ --}}
        <h2 id="currentDate" class="text-right mb-3 " style="text-align: right; margin-right: 10px; font-size: 40px; ">
            {{ $today }} </h2>
    </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <input type="date" id="filterDate" class="filterDate " name="listdate"
                            onchange="filterBookings()"
                            style=" width: 200px; height: 30px;  margin: 30px; margin-top: 10px;">
                    ...
                    <table id="booking-today" class="table table-striped table-booking" type="today" style="width:100%">
                        <thead>
                            <tr>
                                <th>รหัสการจอง</th>
                                <th>เลขอ้างอิง</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($list_checkin_today as $booking)
                                <tr>
                    ...
                    <table id="booking-date" class="table table-striped table-booking-date" type="date"
                        style="width:100%">
                        <thead>
                            <tr>
                                <th>รหัสการจอง</th>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="mt-3">
                                                    <label class="form-label" style="font-weight: 500;">จำนวนวันที่เข้าพัก
                                                        (วัน)</label>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="mt-3">
                                                    <label class="form-label" style="font-weight: 500;">ราคารวม
                                                        (บาท)</label>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="mt-3">
                                                    <label class="form-label"
                                                        style="font-weight: 500;">วันเวลาที่จอง</label>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="mt-3">
                                                    <label class="form-label"
                                                        style="font-weight: 500;">สถานะการจอง</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                                                <div class="mt-3">
                                                    <label class="form-label"
                                                        style="font-weight: 500;">การชำระเงิน</label>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                                                <div class="mt-3">
                                                    <label class="form-label"
                                                        style="font-weight: 500;">ประเภทการจอง</label>
                                                    <input name="payment_type" type="text"
                                                        class="form-control form-booking shadow-none text-center" readonly>
                                                </div>
                                            </div>
                ...
                @section('script')
                    <script src="/js/backoffice/list_checkin_today.js"></script>
                @endsection
