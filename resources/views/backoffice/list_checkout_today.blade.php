...
<div class="d-flex align-items-center  justify-content-between  ">
    ...
    {{-- วันที่ --}}
    <h2 id="currentDate" class="text-right mb-3 " style="text-align: right; margin-right: 10px; font-size: 40px; "> {{ $today}} </h2>
</div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center gap-2">
                        <h5 class="card-title m-0 mb-4">
                            #รายการเช็คเอาท์วันนี้
                        </h5>
                        
                            <input type="date" id="filterDate" class="filterDate "  name="listdate" onchange="filterBookings()" 
...
<table id="booking-today" class="table table-striped table-booking" type="today" style="width:100%">
    ...
    <tbody >
        ...
        @foreach ($list_checkout_today as $booking)
          

            {{-- @if ($booking->date_checkin === )  --}}
                <tr>
...
<table id="booking-date" class="table table-striped table-booking-date " type="date" style="width:100%">
    <thead>
        <tr>
            <th>รหัสการจอง</th>
            <th>เลขอ้างอิง</th>
...
@section('script')
    <script src="/js/backoffice/list_checkout_today.js"></script>
@endsection
